...
export const BurgerIngredients: FC = () => {
  ...
  const buns = ingredients.filter((ingr: TIngredient) => ingr.type === 'bun');
  const mains = ingredients.filter((ingr: TIngredient) => ingr.type === 'main');
  const sauces = ingredients.filter(
    (ingr: TIngredient) => ingr.type === 'sauce'
  );
